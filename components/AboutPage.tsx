        ...
        <section className="bg-indigo-600 py-20 text-white relative overflow-hidden">
          ...
          <div className="max-w-4xl mx-auto px-4 text-center relative z-10">
            ...
            <p className="text-indigo-100 text-xl max-w-2xl mx-auto leading-relaxed">
              We're on a mission to combine the magic of AI with the timeless joy of coloring, giving every child the power to create their own world.
            </p>
          </div>
        </section>
        ...
        <section className="py-20 px-4">
          <div className="max-w-3xl mx-auto">
            ...
            <div className="prose prose-lg prose-slate mx-auto text-slate-600 leading-relaxed space-y-6">
              <p>
                ColorCraft began with a simple problem: a rainy Saturday afternoon and a child who wanted to color a "T-Rex eating pizza on the moon." No coloring book in the house had that specific page, and searching online yielded low-quality results.
              </p>
              <p>
              ...
              <p>
                Leveraging the latest advancements in Generative AI, specifically Google's Gemini models, we built ColorCraft. It's not just an app; it's a creative companion that listens to a child's ideas and brings them to life in seconds.
              </p>
            </div>
          </div>
        </section>
